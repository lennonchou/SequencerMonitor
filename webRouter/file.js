...
exports.getUnlinkedFiles = function (req, res) {
    ...
    async.parallel({
        files: function (callback) {
            connection.myQuery(helper.constructSelectSQL(columns, 'File LEFT JOIN Sample ON File.sampleNumber = Sample.sampleNumber') + ' WHERE Sample.sampleNumber IS NULL ORDER BY ? LIMIT ?, ?', 
